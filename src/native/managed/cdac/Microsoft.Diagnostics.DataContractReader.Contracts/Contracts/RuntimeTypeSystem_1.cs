...
internal partial struct RuntimeTypeSystem_1 : IRuntimeTypeSystem
{
    ...
    public bool IsPrimitive(TypeHandle typeHandle)
        => typeHandle.IsMethodTable() && _methodTables[typeHandle.Address].Flags.GetFlag(MethodTableFlags_1.WFLAGS_HIGH.Category_Mask) == MethodTableFlags_1.WFLAGS_HIGH.Category_TruePrimitive;
